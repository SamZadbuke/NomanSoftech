...
public interface CustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Transactional
    @Modifying
    @Query("UPDATE CustomerOrder o SET o.orderStatus = :status WHERE o.orderId = :orderId")
...
//    List<ProductSummary> findYearlyForAll();
    ...
    @Query("SELECT oi FROM OrderItem oi JOIN oi.customerOrder o JOIN o.customer c " +
               "WHERE c.customer_id = :customerId AND o.orderId = :orderId")
...
//    List<CustomerOrder> findByCustomerorders_Customer_customer_id(Integer customerId);
    
    //new 


    // ✅ Get order details with items
    @Query("SELECT o FROM CustomerOrder o JOIN FETCH o.items WHERE o.orderId = :orderId")
