package com.nomansoftech.models;
...
public class ResponseStructure {
	...
	public static ResponseStructure onFailure(int statusCode, String message) {
	    return new ResponseStructure(statusCode, "failure", null, null, message);
	}
