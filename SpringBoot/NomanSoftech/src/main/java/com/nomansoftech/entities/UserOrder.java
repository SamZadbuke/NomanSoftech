...
public class UserOrder {
    ...
    // 🔹 Delivery mapping (optional entity, kept as Integer for now)
	...
	public UserOrder(Integer id, User user, Integer deliveryId, LocalDate orderDate, LocalTime orderTime,
			OrderStatus orderStatus, LocalDateTime createdAt, LocalDateTime updatedAt, List<OrderItem> items,
