...
//    
 ...
 //  orders
    ...
    public CustomerOrder getOrderDetails(@PathVariable Integer customerId,
        ...
        // optional: validate that this order belongs to that customer
        CustomerOrder order = customerService.getOrderDetails(orderId);
    ...
    // ✅ Buyer’s orders (separate endpoint for users)
